...
<html>
    <head>
        ...
        <title>IOT Powered Pet Care System</title>
        <style>
    ...
    <body>
    <div align=center><h1 style="color:blue;">IOT Powered Pet Care System<h1></div>
    <br/>
    <br/>
    <div align=center> 
    ...
    <br/>
    <div align=center>
    <button class="button" id="forwardleft" ontouchstart="fetch(document.location.origin+'/control?var=car&val=6');" ontouchend="fetch(document.location.origin+'/control?var=car&val=3');" >Forward Left</button>
    ...
    <button class="button" id="forwardright" ontouchstart="fetch(document.location.origin+'/control?var=car&val=7');" ontouchend="fetch(document.location.origin+'/control?var=car&val=3');" >Forward Right</button>
    ...
    <br/>
    <div align=center>
    <button class="button" id="backwardleft" ontouchstart="fetch(document.location.origin+'/control?var=car&val=8');" ontouchend="fetch(document.location.origin+'/control?var=car&val=3');">Backward Left</button> 
    ...
    <button class="button" id="backwardright" ontouchstart="fetch(document.location.origin+'/control?var=car&val=9');" ontouchend="fetch(document.location.origin+'/control?var=car&val=3');">Backward Right</button>
